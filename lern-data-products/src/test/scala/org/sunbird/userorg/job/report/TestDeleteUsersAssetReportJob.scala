...
class TestDeleteUsersAssetReportJob extends SparkSpec(null) with MockFactory {
  ...
  "DeletedUsersAssetsReportJob" should "generate reports" in {
    val strConfig = """{"search":{"type":"none"},"model":"org.sunbird.userorg.job.report.DeletedUsersAssetsReportJob","modelParams":{"configuredUserId":"A,B","configuredOrganisationId":"","configuredChannel":"C,D"}}"""
